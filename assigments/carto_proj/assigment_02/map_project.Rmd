...
output: 
  flexdashboard::flex_dashboard:
    source_code: "https://github.com/csaybar/digitalearth/assigments/carto_proj/assigment_02"
    storyboard: no
    social: menu
    source: embed
    css: style/style.css
...
From the 33 Salzburg districts we observed that 10 of them present a population density greater than  **3000** **people/ km<sup>2</sup>**. These are: Neustadt, Lehen-Nord, Elisabeth-Vorstadt, Liefering-Ost, Taxham, Schallmoos, Maxglan, Liefering-West, Aiglhof/Innere Riedenburg, and Rechte Altstadt/Andräviertel. 

On the other hand, Hellbrunn and Gaisberg were the district with the lowest population density presenting a value of 863 and 430 **people/ km<sup>2</sup>** respectively.
